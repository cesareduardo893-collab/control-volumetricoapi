...
// Google OAuth (API signin only - redirect/callback en web.php)
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // ==================== EMULADOR ====================
    Route::get('emulador/tanques/instalacion/{instalacionId}', [EmuladorController::class, 'tanquesPorInstalacion']);
    Route::get('emulador/lectura/{tanqueId}', [EmuladorController::class, 'lectura']);
    Route::get('emulador/tanque/datos-automaticos', [EmuladorController::class, 'datosAutomaticos']);
    Route::get('emulador/tanque/serial/{instalacionId}', [EmuladorController::class, 'serial']);
    Route::post('emulador/tanque/simular-llenado', [EmuladorController::class, 'simularLlenado']);
